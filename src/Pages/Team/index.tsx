...
const teamMembers = [
   {
     name: 'Benjamin Ford',
     role: 'Co-founder, CEO',
     image: `${import.meta.env.VITE_REDIRECT}/img/team/BENJAMIN_FORD.jpg?v=2`,
     linkedin: '',
     animationDelay: '0.1s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/AMANDA_VELASQUEZ.jpg?v=2`,
     linkedin: '',
     animationDelay: '0.4s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/JON_SNOWDEN.jpg?v=2`,
     linkedin: '',
     animationDelay: '0.7s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/JOHN_DAVIS.jpg?v=2`,
     linkedin: '',
     animationDelay: '1s',
   },
   // Add more team members as needed
   {
     ...
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/JASMINE_VALENTINE.jpg?v=2`,
     linkedin: "",
     animationDelay: "0.4s",
   },
   {
     name: "Richard Abdul",
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/RICHARD_ABDUL.jpg?v=2`,
     linkedin: "",
     animationDelay: "0.7s",
   },
   {
     ...
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/JESSICA_SANCHES.jpg?v=2`,
     linkedin: "",
     animationDelay: "1s",
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/GABRIELLA_LAUREN.jpg?v=2`,
     linkedin: "",
     animationDelay: "0.2s",
   },
   {
     name: "Joseph Agabin",
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/JOSEPH_AGABIN.jpg?v=2`,
     linkedin: "",
     animationDelay: "0.5s",
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/PHOEBE_FAMIA.jpg?v=2`,
     "linkedin": "",
     "animationDelay": "0.6s"
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/ALFREDO_SUAREZ.jpg?v=2`,
     "linkedin": "",
     "animationDelay": "0.9s"
   },
   {
     "name": "Trixie Xhan",
     "role": "HR Manager",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/TRIXIE_XHAN.jpg?v=2`,
     "linkedin": "",
     "animationDelay": "0.4s"
   }
 ];
