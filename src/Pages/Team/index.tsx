...
const teamMembers = [
   {
     name: 'Benjamin Ford',
     role: 'Co-founder, CEO',
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Benjamin_Ford.jpeg?v=2`,
     linkedin: '',
     animationDelay: '0.1s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Amanda_Velasquez.jpeg?v=2`,
     linkedin: '',
     animationDelay: '0.4s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Jon_Snowden.jpeg?v=2`,
     linkedin: '',
     animationDelay: '0.7s',
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/John_Davis.jpeg?v=2`,
     linkedin: '',
     animationDelay: '1s',
   },
   // Add more team members as needed
   {
     ...
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Jasmine_Valentine.jpeg?v=2`,
     linkedin: "",
     animationDelay: "0.4s",
   },
   {
     name: "Richard Abdul",
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Richard_Abdul.jpeg?v=2`,
     linkedin: "",
     animationDelay: "0.7s",
   },
   {
     ...
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Jessica_Sanchez.jpeg?v=2`,
     linkedin: "",
     animationDelay: "1s",
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Gabriella_Lauren.jpeg?v=2`,
     linkedin: "",
     animationDelay: "0.2s",
   },
   {
     name: "Joseph Agabin",
     role: "Consultant",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Joseph_Agabin.jpeg?v=2`,
     linkedin: "",
     animationDelay: "0.5s",
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Phoebe_Famia.jpeg?v=2`,
     "linkedin": "",
     "animationDelay": "0.6s"
   },
   {
     ...
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Alfredo_Suarez.jpeg?v=2`,
     "linkedin": "",
     "animationDelay": "0.9s"
   },
   {
     "name": "Trixie Xhan",
     "role": "HR Manager",
     image: `${import.meta.env.VITE_REDIRECT}/img/team/Trixie_Xhan.jpeg?v=2`,
     "linkedin": "",
     "animationDelay": "0.4s"
   }
 ];
